...
export const POST_UPDATE_COMMENT_REQUEST = 'POST_UPDATE_REQUEST';
export const POST_UPDATE_COMMENT_SUCCESS = 'POST_UPDATE_SUCCESS';
export const POST_UPDATE_COMMENT_FAIL = 'POST_UPDATE_FAIL';
